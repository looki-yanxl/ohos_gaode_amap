...
public interface ILocationServiceAIDL extends android.os.IInterface
{
  ...
  {
    private static final String DESCRIPTOR = "com.yilin.xbr.xbr_gaode_amap.ILocationServiceAIDL";
    ...
    /**
     * Cast an IBinder object into an com.yilin.xbr.xbr_gaode_amap.ILocationServiceAIDL interface,
